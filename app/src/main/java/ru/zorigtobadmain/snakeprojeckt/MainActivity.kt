...
import ru.zorigtobadmain.snakeprojeckt.SnakeCore.gameSpeed
import ru.zorigtobadmain.snakeprojeckt.SnakeCore.isPlay
import ru.zorigtobadmain.snakeprojeckt.SnakeCore.startTheGame
...
class MainActivity : AppCompatActivity() {
    ...
    private var currintDirections = Direction.BOTTOM
    ...
    private fun checkIfCurrentDirectionIsNotOpposite(
        ...
        if (currintDirections == oppositeDirections) {
            move(currintDirections)
        } else {
